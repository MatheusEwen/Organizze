...
public class CadastroActivity extends AppCompatActivity {
    ...
    private FirebaseAuth autenticaticao;
    ...
    public void cadastrarUsuario(){
        ...
        autenticaticao = ConfiguracaoFirebase.getFirebaseAutenticacao();
        autenticaticao.createUserWithEmailAndPassword(usuario.getEmail(), usuario.getSenha())
